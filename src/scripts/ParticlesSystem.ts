...
type ParticleEmitterCreator = (clock: number, emitterInstance: ParticleEmitterInstance) => void;
type ParticleEmitterProcessor = (sprite: ParticleSprite, emitterInstance: ParticleEmitterInstance) => void;
...
export class ParticleEmitter {
    ...
    constructor(creator: ParticleEmitterCreator, processor: ParticleEmitterProcessor) {
...
export class ParticlesSystem extends PIXI.Container {
    ...
    public spawnEmitterInstance(key: string, age: number, maxParticles: number = 10): ParticleEmitterInstance {
        ...
        while (ins) {
            if (ins.active) {
                ...
                if (ins.activeSpriteCount === 0) {
                    ...
                    if (ins.prevLink === null && ins.nextLink === null) this.emittersInstances = null
                    ins.emitter.free(removeIns)
                }


            } else if (ins.activeSpriteCount === 0) {
                // if (ins.prevLink === null && ins.nextLink === null) this.emittersInstances = null
